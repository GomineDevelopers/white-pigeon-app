...
let api = {
  ...
  regionDoctorBatch: (params) => post("/regionManager/regionDoctorBatch", params), //区域经理审核医生（通过&拒绝）批量审核
  ...
  meetingApplyRecord: (params) => post("/meetingManager/meetingApplyRecord", params), //会议统计
  ...
  getProductByHospitalProduct: (params) =>
    post("/regionManager/getProductByHospitalProduct", params), //经理端顶部筛选获取产品数据
  ...
  getFlowsExcel: (params) => post("/regionManager/getFlowsExcel", params), //经理端获取产品流向下载
};
export default api;
